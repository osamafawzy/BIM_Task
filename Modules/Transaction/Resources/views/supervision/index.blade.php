        ...
        $(function() {
            ...
            if (dt_basic_table.length) {
                var dt_basic = dt_basic_table.DataTable({
                    ajax: '/admin/school/' + school_id + '/supervision',
                    columns: [{
                            data: 'id'
                        }, // for responsive show
                        {
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                return (
                                    ...
                                    '</div>' +
                                    '</div>'
                                    @can('Edit-supervision')
                                        +
                                        '<a href="/admin/school/' + school_id +
                                            '/supervision/' + full['title'] +
            ...
            $('.datatables-basic tbody').on('click', '.delete-record', function() {
                let that = this;
                var id = dt_basic.row($(this).parents('tr')).data().title

    ...
    @section('content')
        <div class="col-lg-12 col-12">
            <div class="card">
                <div
                    ...
                    ">
                    <div>
                        <h4 class="card-title mb-25"> فلترة سجل توزيع حصص الانتظار
                        </h4>
        ...
        @can('Download-attendence_log')
            <div class="d-flex flex-wrap justify-content-end">
                <a href="{{ URL::route('alternatives.download', ['school_id' => $school_id, 'date' => isset($_GET['date']) && $_GET['date'] !== null ? $_GET['date'] : null]) }}"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-flex justify-content-between">
                                <div class="pt-2 pb-2">زملائي المعلمين/نظرا لغياب الزميل {{ $key }}</div>
                                <div class="pt-2 pb-2">
                                    لهذا اليوم :{{ $_GET['date'] ?? date('Y-m-d') }}/ {{arabicDayName()[$value[0]['day_name']]}}

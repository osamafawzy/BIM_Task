    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">انشاء التوقيت الزمني الخاص بالمدرسة</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal invoice-repeater" action="{{url('admin/school/'.request()->route('school_id').'/classTiming')}}" method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                            ...
                            <div data-repeater-item>
                                <div class="row d-flex align-items-end">
                                    <div class="col-md-3 col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="itemtitle">الحصة</label>
                                            <input type="text" required name="title" class="form-control" id="itemtitle" aria-describedby="itemtitle" placeholder="الحصة" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2 col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="itemquantity">النوع</label>

  ...
  {{-- <script src="{{asset('')}}js/schools/script.js"></script> --}}
    ...
    if (dt_basic_table.length) {
        var dt_basic = dt_basic_table.DataTable({
            ajax: '/admin/school/'+school_id+'/classTiming',
            columns: [
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    targets: -4,
                    render: function (data, type, full, meta) {
                        if (data === 'class') return 'حصة دارسية';
                        else return 'راحة';
                    }
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            @can('Delete-class-timing') +
                            '<a href="javascript:;" class="dropdown-item delete-record">' +
                            feather.icons['trash-2'].toSvg({ class: 'font-small-4 me-50' }) +
                            'حذف</a>'@endcan +
                            '</div>' +
                            '</div>'
                            @can('Edit-class-timing')
                            +
                            '<a href="/admin/school/'+school_id+'/classTiming/'+data+'/edit" class="item-edit">' +
            ...
            buttons: [
...

                {
                    ...
                    action: function (e, dt, node, config)
                    {
                        ...
                        window.location.href = '/admin/school/'+school_id+'/classTiming/create';
                    },
                    init: function (api, node, config) {
                        $(node).removeClass('btn-secondary');
                    }
    ...
    $('.datatables-basic tbody').on('click', '.delete-record', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax(
                    {
                        url: window.location.origin+"/admin/school/"+school_id+"/classTiming/"+id,
                        type: 'POST',
                        data: {
                            "id": id,
                            "_method": "DELETE",

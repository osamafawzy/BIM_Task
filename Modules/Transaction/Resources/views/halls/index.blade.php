  ...
  {{-- <script src="{{asset('')}}js/schools/script.js"></script> --}}
    ...
    if (dt_basic_table.length) {
        var dt_basic = dt_basic_table.DataTable({
            ajax: '/admin/school/'+school_id+'/halls',
            columns: [
                ...
                },
                {
                    ...
                    render: function (data, type, full, meta) {
                        return (
                            ...
                            @can('Edit-hall')
                            +
                            '<a href="/admin/school/'+school_id+'/halls/'+data+'/edit" class="item-edit">' +
            ...
            buttons: [
...

                {
                    ...
                    action: function (e, dt, node, config)
                    {
                        ...
                        window.location.href = '/admin/school/'+school_id+'/halls/create';
                    },
                    init: function (api, node, config) {
                        $(node).removeClass('btn-secondary');
                    }
    ...
    $('.datatables-basic tbody').on('click', '.delete-record', function () {
        ...
        Swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax(
                    {
                        url: window.location.origin+"/admin/school/"+school_id+"/halls/"+id,
                        type: 'POST',
                        data: {
                            "id": id,
                            "_method": "DELETE",

...
@section('content')
    <div class="col-md-12 col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form form-horizontal" enctype="multipart/form-data" action="{{ url('admin/news/') }}"
                    method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                <div class="col-sm-3 text-center">
                                    <label class="col-form-label" for="fname-icon"> الصوره</label>
                                </div>
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="file" class="form-control" name="image" placeholder="صوره"
                                            value="{{ old('image') }}" />
                                        @error('image')
                                            <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        ...
                                        <input type="file" id="pass-icon" class="form-control" name="file"
                                            placeholder="file" />
                                    </div>
                                </div>
                            </div>

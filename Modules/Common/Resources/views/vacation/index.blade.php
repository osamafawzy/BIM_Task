        ...
        <div class="card">
            <div
                class="
                    ...
                    ">
                <div>
                    <h4 class="card-title mb-25"> فلترة العطله او الاجازه الرسميه
                    </h4>
...
@section('js')
    ...
    @if (session('updated'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم تعديل العطله او الاجازه الرسميه بنجاح',
                icon: 'success',
                customClass: {
    ...
    @if (session('notification'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم ارسال اشعار العطله او الاجازه الرسميه بنجاح',
                icon: 'success',
                customClass: {
                    confirmButton: 'btn btn-primary'
                },
    ...
    @if (session('created'))
        <script>
            Swal.fire({
                title: 'أحسنت!',
                text: 'لقد تم انشاء العطله او الاجازه الرسميه بنجاح',
                icon: 'success',
                customClass: {
                    confirmButton: 'btn btn-primary'
                },
    ...
    <script>
        $(function() {
           ...
           // console.log(date);
            var schoolId = url.searchParams.get("school_id")

            var ajaxRequest = "vacation?";
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                return (
                                    ...
                                    +
                                    '<a href="vacation/' + data +
                                    '/sendNotification" class="item-edit pe-1">' +
                        ...
                        @can('Create-vacation')
...

                            {
                                ...
                                action: function(e, dt, node, config) {
                                    ...
                                    window.location.href = './vacation/create';
                                },
                                init: function(api, node, config) {
                                    $(node).removeClass('btn-secondary');
                                }
            ...
            $('.datatables-basic tbody').on('click', '.delete-record', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: window.location.origin + "/admin/vacation/" + id,
                            type: 'POST',
                            data: {
                                "id": id,
                                "_method": "DELETE",

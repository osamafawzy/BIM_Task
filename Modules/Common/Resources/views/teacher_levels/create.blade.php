    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">انشاء مادة مستوي /رتبة جديدة</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" action="{{url('admin/teacher_levels/')}}" method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1 row">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group-merge">
                                        <select class="select2 form-select dt-role"
                                                name="for">
                                            <option value="administrative">ادارى</option>

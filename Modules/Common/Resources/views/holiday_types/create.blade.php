    ...
    <div class="col-md-12 col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">انشاء اجازه جديده</h4>
            </div>
            <div class="card-body">
                <form class="form form-horizontal" action="{{url('admin/holiday_types/')}}" method="POST">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-12">
                            <div class="mb-1 row">
                        ...
                        <div class="col-12">
                            <div class="mb-1 row">
                                <div class="col-sm-3 text-center">
                                    <label class="col-form-label" for="fname-icon"> عدد الاجازات</label>
                                </div>
                                <div class="col-sm-9">
                                    <div class="input-group input-group-merge">
                                        <span class="input-group-text"><i data-feather="user"></i></span>
                                        <input type="text" class="form-control" name="days_number" placeholder="عدد الاجازات" value="{{old('days_number')}}" />
                                        @error('days_number')
                                        <p class="alert alert-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
